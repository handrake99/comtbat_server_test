...
{
    public class RedisTaskCharacterInfo : RedisTask
    {
        public string CharId { get; private set; }
        public SharedMemberInfo MemberInfo { get; private set; }

        public RedisTaskCharacterInfo(string charId, RedisRequestType requestType) : base(requestType)
        {
            CharId = charId;
        }
        ...
        public override void Invoke()
        {
            ...
            CorgiCombatLog.Log(CombatLogCategory.System, "Get RedisTaskCharacterInfo from Redis. CharacterId[{0}]", CharId);

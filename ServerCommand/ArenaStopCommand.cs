...
{
    public class ArenaStopCommand : RedisCommand
    {
        public ArenaStopCommand()
        {
            CommandType = CommandType.PvpStop;
        }
        ...
        public override void Invoke(JObject json)
        {
            ...
            {
                CorgiLog.LogError("invalid command parameter for ArenaStopCommand\n");
                return;
            }
            ...
            CorgiCombatLog.Log(CombatLogCategory.System, "Get ArenaStopCommand Request {0}/{1}\n", roomId, characterId);
            RoomManager.Instance.SerializeMethod("OnArenaStop", roomId, characterId, dungeonKey);
        }
    }
}
...
{
    public class RiftStopCommand : RedisCommand
    {
        public RiftStopCommand()
        {
            CommandType = CommandType.RiftStop;
        }
        ...
        public override void Invoke(JObject json)
        {
            ...
            {
                CorgiLog.LogError("invalid command parameter for RiftStopCommand\n");
                return;
            }
            ...
            CorgiCombatLog.Log(CombatLogCategory.System, "Get RiftStopCommand Request {0}/{1}\n", roomId, characterId);
            RoomManager.Instance.SerializeMethod("OnRiftStop", roomId, characterId, dungeonKey);
        }
    }
}